...
select product_id, facility_id, sum(quantity)
from work_effort we
...
group by icii.product_id, we.FACILITY_ID
order by we.CREATED_DATE desc, ici.CREATED_DATE desc;
